...
def dijkstra(start_node, end_node):
    ...
    while distance_dict:
        ...
        # a = np.array(distance_dict)
        # print(a)
        # visited_vertex.append(current_node)
        ...
        for edge in current_node.edges:
            ...
            if edge.node in distance_dict:
                ...
                if distance_dict[edge.node] > new_node_distance:
                    visited_vertex.append(edge.node)
                    distance_dict[edge.node] = new_node_distance
            # visited_vertex.append(edge.node)        

    return shortest_path_to_node[end_node], visited_order, visited_vertex
